...
<script type="text/javascript">
	function change() {
		...
		img.src = "${pageContext.request.contextPath}/admin/login/checkCode?"
				+ new Date;
	}
</script>
<style>
...
<body background="#fff">
	<div class="row" style="margin-top: 160px;">
		<div class="col-md-8 col-md-offset-2"
			...
			<img class="col-md-7" src="${pageContext.request.contextPath}/resources/images/index.jpg" style="height: 350px;" />
			<form action="${pageContext.request.contextPath}/login/userLogin"
				method="post" style="margin-top: 40px;">
				&nbsp;&nbsp;&nbsp;<font size="3" color="red">${result}</font><font size="3" color="red">${error}</font>
				...
				<div class="form-group" style="color: black;">
					<label for="inputGoodsPriceLB" class="col-sm-5 control-label">密码：</label>
					<div class="col-md-5">
						...
						<div class="row">
							<div class="col-md-5">
								<img name="checkCodeImg" id="checkCodeImg"
									src="${pageContext.request.contextPath}/admin/login/checkCode"
				...
				<div class="form-group">
					<div class=" col-md-5">
						<button type="submit"
							...
							<a class="btn btn-info col-md-4 col-md-offset-1"
							style="margin-top: 10px;" href="${pageContext.request.contextPath}/login/EXE_adduser">注册</a>
					</div>
				</div>
			</form>
		</div>
